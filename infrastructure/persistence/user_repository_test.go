...
func TestSaveUser_Success(t *testing.T) {
	...
	user.Email = "kurnia@gmail.com"
	user.FullName = "kurnia"
	user.UserStatus = "1"
	...
	assert.EqualValues(t, u.Email, "kurnia@gmail.com")
	assert.EqualValues(t, u.FullName, "kurnia")
